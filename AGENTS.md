...
/cmd/cli/                → command definitions — existing: root.go, init.go, monitor.go, backup.go, exec.go, diff.go, tui.go (+tui_*.go, ~3,650 lines) — new (Phase 0+): serve.go, migrate.go, import_devices.go
